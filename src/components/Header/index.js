                ...
                <nav className="bg-white border-gray-200 px-4 lg:px-6 py-5 dark:bg-gray-800">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div
                            ...
                            id="mobile-menu-2">
                            <div
                                className="header-menu flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                ...
                                <div className='relative'>
                                    <div
                                        className='text-[white] rounded-[50%] bg-amber-600 absolute px-1 text-[10px] right-[-14px] top-0 z-0'>{basket.length > 0 ? basket.length : ''}</div>
                                    <NavLink to="/basket"
                                             className="block py-2 pr-4 pl-3 text-gray-700 text-xl border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                                    >Basket</NavLink>
                                </div>
                                ...
                                <div className='relative'>
                                    <div
                                        className='text-[white] rounded-[50%] bg-amber-600 absolute px-1 text-[10px] right-[-12px] top-0 z-0'>{favorites.length > 0 ? favorites.length : ''}</div>
